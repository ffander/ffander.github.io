...
toggleschedule.onclick = function () {
  if (!scheduleshowing) {
    schedule.style.maxHeight = '1200px';
...
var floreal = document.querySelector('#floreal');
var costantino = document.querySelector('#costantino');
var abstract = document.querySelector('#abstract');
var fffss = document.querySelector('#fffss');
var native = document.querySelector('#native');

fio.onclick = function () {
  window.open('https://rocketradiolive.com/broadcast/mdw19-heron-preston-x-nike-by-you-day-3-w-francis-inferno-orchestra');
};

floreal.onclick = function () {
  window.open('https://rocketradiolive.com/broadcast/eternal-love-002-w-flo-real-mahogani-music');
};

costantino.onclick = function () {
  window.open('https://rocketradiolive.com/broadcast/carhartt-wip-presents-fela-kuti-collection-release-w-raffaele-costantino-carhartt-wip-store-milano');
};

abstract.onclick = function () {
  window.open('https://rocketradiolive.com/broadcast/special-002');
};

fffss.onclick = function () {
  window.open('https://rocketradiolive.com/broadcast/rr-x-ffff2019-with-fat-fat-fat-soundsystem');
};

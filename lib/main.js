      ...
      playPromise.then(() => {
        ...
        if ('mediaSession' in navigator) {
          ...
          navigator.mediaSession.metadata = new MediaMetadata({
            ...
            artwork: [{ src: '/lib/ffflogo.png', sizes: '96x96', type: 'image/png' }, { src: '/lib/ffflogo.png', sizes: '128x128', type: 'image/png' }, { src: '/lib/ffflogo.png', sizes: '192x192', type: 'image/png' }, { src: '/lib/ffflogo.png', sizes: '256x256', type: 'image/png' }, { src: '/lib/ffflogo.png', sizes: '384x384', type: 'image/png' }, { src: '/lib/ffflogo.png', sizes: '512x512', type: 'image/png' }]
          });
        }
        //
      }).catch(e => {
